      ...
      <section id="states" className="space-y-6">
        ...
        <div className="space-y-3">
          ...
          <RuleCard label="Error — group validation failed">
            Set <C>state=&quot;error&quot;</C> to indicate that the group has a validation error. Pair with <C>message</C> to provide accessible error text rendered below the group. The legacy <C>error</C> and <C>errorMessage</C> props are deprecated — migrate to <C>state</C> and <C>message</C>.
          </RuleCard>
        </div>
      </section>
