...
declare module 'react' {
  ...
  'io-button': React.DetailedHTMLProps<React.HTMLAttributes<HTMLIoButtonElement>, HTMLIoButtonElement> & Partial<StencilJSX.IoButton> & { value?: string };
  'io-button-group': React.DetailedHTMLProps<React.HTMLAttributes<HTMLElement>, HTMLElement> & { exclusive?: boolean; value?: string | string[]; disabled?: boolean; label?: string; onchange?: (e: CustomEvent<{ value: string | string[] }>) => void };
