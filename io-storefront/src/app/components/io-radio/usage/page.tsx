      ...
      <section id="grouping" className="space-y-6">
        ...
        <div className="space-y-3">
          ...
          <RuleCard label="Set a unique value on each option">
            The <C>value</C> prop distinguishes options within the group. When the user selects a radio, the <C>change</C> event detail carries the option&rsquo;s value string. If value is omitted it defaults to an empty string, making all options indistinguishable in event handlers.
          </RuleCard>
