    ...
    <div className="space-y-16">
      ...
      <section id="choosing-between-overlays" className="space-y-6">
        ...
        <div className="space-y-3">
          ...
          <RuleCard label="io-flyout — full-height side panel">
            Use <C>io-flyout</C> when you need a full-height side panel at a fixed width (<C>480px</C>, 100vw on narrow viewports) — such as mega menus, navigation panels, or contextual toolbars. Prefer this over a right-placement drawer when the panel does not need flexible sizing.
          </RuleCard>
