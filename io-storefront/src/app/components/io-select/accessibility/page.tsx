    ...
    <div className="space-y-16">
      ...
      <section id="keyboard-interaction-combobox" className="space-y-6">
        ...
        <KeyboardTable
          rows={[
            ...
            {
              key: <Kbd>↑</Kbd>,
              action: 'Moves focus to the previous option in the filtered list (wraps to last).',
            },
            {
              key: <Kbd>Enter</Kbd>,
      ...
      <section id="best-practices" className="space-y-4">
        ...
        <RuleCard label="Do not disable individual options as category headers">
          Disabled options with no value are sometimes used as visual group separators. This pattern is not accessible — use{' '}
          <code className="text-xs font-mono px-1.5 py-0.5 rounded" style={{ background: 'var(--io-bg-surface)', border: '1px solid var(--io-border)', color: 'var(--io-text-primary)' }}>io-optgroup</code>{' '}
          as a child of <code className="text-xs font-mono px-1.5 py-0.5 rounded" style={{ background: 'var(--io-bg-surface)', border: '1px solid var(--io-border)', color: 'var(--io-text-primary)' }}>io-select</code>{' '}
          to provide labelled grouping with correct semantics.
        </RuleCard>
