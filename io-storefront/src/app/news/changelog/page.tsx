...
function getChangelog() {
  // io-components/CHANGELOG.md is auto-generated by changesets on every release.
  // The root CHANGELOG.md is the manually maintained high-level history.
  // We prefer the package changelog so merging the release PR (PR #671 pattern)
  // automatically surfaces new entries here at the next storefront build.
  const candidates = [
    path.join(process.cwd(), '..', 'io-components', 'CHANGELOG.md'),
  ...
  console.error('[changelog] Failed to read any CHANGELOG.md');
  return [];
}
