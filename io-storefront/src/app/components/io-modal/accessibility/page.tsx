      ...
      <section id="keyboard-interaction" className="space-y-6">
        ...
        <KeyboardTable
          rows={[
            ...
            {
              key: <Kbd>Esc</Kbd>,
              action: 'Closes the modal and emits the dismiss event. This is native browser behaviour provided by showModal(). Focus returns to the element that opened the modal.',
            },
            {
              key: <Kbd>Enter</Kbd>,
