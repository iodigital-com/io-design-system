...
declare module 'react' {
  ...
  'io-segment': React.DetailedHTMLProps<React.HTMLAttributes<HTMLElement>, HTMLElement> & { value?: string; label?: string; disabled?: boolean; icon?: string; selected?: boolean };
  'io-segmented-control': React.DetailedHTMLProps<React.HTMLAttributes<HTMLElement>, HTMLElement> & { value?: string; name?: string; disabled?: boolean };
